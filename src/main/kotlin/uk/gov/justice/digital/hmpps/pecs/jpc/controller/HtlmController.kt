...
data class Summary(val month: String, val movesWithoutPrices: Int, val totalMoves: Int, val supplier: String, val jpcVersion: String, val totalPrice: Double)
...
class HtmlController {
    ...
    fun dashboard(model: ModelMap): String {
        model.addAttribute("summary", Summary(month = "March 2020", movesWithoutPrices = 1, totalMoves = 100, supplier = "SERCO", jpcVersion = "JPC_SERCO_310320", totalPrice = 100000.0))
